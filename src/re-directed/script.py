...
html_base = lambda url: data['html_base'].format(url=url)
...
transfer_url_base = lambda domain, filename: data['transfer_url_base'].format(url_base=data['url_base'], domain=domain, filename=filename)
